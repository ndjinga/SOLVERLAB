...
def test_validation2DWaveSystemPStagFlatCrossTriangles(scaling):
    ...
    print("FV PStag on 2D flat cross triangle meshes : scheme order for pressure is ", -ap)
...
if __name__ == """__main__""":
    if len(sys.argv) >1 :
        ...
        test_validation2DWaveSystemPStagFlatCrossTriangles(scaling)
    else :
        test_validation2DWaveSystemPStagFlatCrossTriangles(2)
