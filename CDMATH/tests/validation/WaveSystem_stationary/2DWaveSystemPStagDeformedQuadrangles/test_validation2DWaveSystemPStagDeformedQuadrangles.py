...
def test_validation2DWaveSystemPStagDeformedQuadrangles(bctype,scaling):
    ...
    plt.savefig(mesh_name+'_Pressure_2DWaveSystemPStag_'+"PlotOverDiagonalLine.png")
    plt.close()
    ...
    plt.savefig(mesh_name+"_Velocity_2DWaveSystemPStag_"+"PlotOverDiagonalLine.png")    
    plt.close()
    ...
    det=a1*a3-a2*a2
    assert det!=0, 'test_validation2DWaveSystemPStagDeformedQuadranglesFV() : Make sure you use distinct meshes and at least two meshes'
    ...
    plt.savefig(mesh_name+"_Pressure_2DWaveSystemPStag_"+"ConvergenceCurve.png")
    ...
    plt.title('Convergence of finite volumes for the stationary Wave System \n with PStag scheme on 2D deformed quadrangular meshes')
    plt.savefig(mesh_name+"_Velocity_2DWaveSystemPStag_"+"ConvergenceCurve.png")
...
if __name__ == """__main__""":
    if len(sys.argv) >2 :
        ...
        test_validation2DWaveSystemPStagDeformedQuadrangles(bctype,scaling)
    else :
        raise ValueError("test_validation2DWaveSystemPStagDeformedQuadrangles.py expects a mesh file name and a scaling parameter")
