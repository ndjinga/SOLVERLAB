...
def test_validation2DWaveSystemCenteredCrossTriangles(scaling):
    start = time.time()
...
if __name__ == """__main__""":
    if len(sys.argv) >1 :
        ...
        test_validation2DWaveSystemCenteredCrossTriangles(scaling)
    else :
        test_validation2DWaveSystemCenteredCrossTriangles(2)
