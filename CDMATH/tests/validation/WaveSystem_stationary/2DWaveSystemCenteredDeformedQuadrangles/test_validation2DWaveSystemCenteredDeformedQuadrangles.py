...
def test_validation2DWaveSystemCenteredDeformedQuadrangles(bctype,scaling):
    start = time.time()
    ...
    plt.savefig(mesh_name+'_Pressure_2DWaveSystemCentered_'+"PlotOverDiagonalLine.png")
    plt.close()
    ...
    plt.savefig(mesh_name+"_Velocity_2DWaveSystemCentered_"+"PlotOverDiagonalLine.png")    
    plt.close()
    ...
    plt.savefig(mesh_name+"_2DWaveSystemCentered_"+"TimeSteps.png")
    ...
    plt.savefig(mesh_name+"_2DWaveSystemCentered_"+"TimeFinal.png")
    ...
    plt.savefig(mesh_name+"_2DWaveSystemCentered_"+"MaxVelNorm.png")
    ...
    det=a1*a3-a2*a2
    assert det!=0, 'test_validation2DWaveSystemCenteredDeformedQuadranglesFV() : Make sure you use distinct meshes and at least two meshes'
    ...
    plt.savefig(mesh_name+"_Pressure_2DWaveSystemCentered_"+"ConvergenceCurve.png")
    ...
    plt.title('Convergence of finite volumes for the stationary Wave System \n with Centered scheme on 2D deformed quadrangular meshes')
    plt.savefig(mesh_name+"_Velocity_2DWaveSystemCentered_"+"ConvergenceCurve.png")
    ...
    plt.savefig(mesh_name+"_2DWaveSystemCentered_ComputationalTime.png")
...
if __name__ == """__main__""":
    if len(sys.argv) >2 :
        ...
        test_validation2DWaveSystemCenteredDeformedQuadrangles(bctype,scaling)
    else :
        raise ValueError("test_validation2DWaveSystemCenteredDeformedQuadrangles.py expects a mesh file name and a scaling parameter")
