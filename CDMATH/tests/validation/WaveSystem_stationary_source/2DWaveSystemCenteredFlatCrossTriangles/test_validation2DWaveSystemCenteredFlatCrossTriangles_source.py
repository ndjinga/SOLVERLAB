...
def test_validation2DWaveSystemSourceCenteredFlatCrossTriangles(scaling):
    start = time.time()
    ...
    det=a1*a3-a2*a2
    assert det!=0, 'test_validation2DWaveSystemSourceCentered() : Make sure you use distinct meshes and at least two meshes'
...
if __name__ == """__main__""":
    if len(sys.argv) >1 :
        ...
        test_validation2DWaveSystemSourceCenteredFlatCrossTriangles(scaling)
    else :
        test_validation2DWaveSystemSourceCenteredFlatCrossTriangles(2)
