...
def test_validation2DWaveSystemSourceCenteredCrossTriangles(scaling):
    start = time.time()
    ...
    plt.savefig(mesh_name+"_2DWaveSystemSquareSourceCentered_"+"scaling"+str(scaling)+"_TimeSteps.png")
    ...
    det=a1*a3-a2*a2
    assert det!=0, 'test_validation2DWaveSystemFVSourceCentered() : Make sure you use distinct meshes and at least two meshes'
    ...
    plt.savefig(mesh_name+"2DWaveSystemSourceCentered_"+"scaling"+str(scaling)+"_ComputationalTime.png")
...
if __name__ == """__main__""":
    if len(sys.argv) >1 :
        ...
        test_validation2DWaveSystemSourceCenteredCrossTriangles(scaling)
    else :
        test_validation2DWaveSystemSourceCenteredCrossTriangles(2)
