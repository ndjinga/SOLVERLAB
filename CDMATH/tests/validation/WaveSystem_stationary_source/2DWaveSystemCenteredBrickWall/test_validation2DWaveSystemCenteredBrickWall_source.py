...
def test_validation2DWaveSystemSourceCentered_brickwall(scaling):
    ...
    det=a1*a3-a2*a2
    assert det!=0, 'test_validation2DWaveSystemBrickWallFVSourceCentered() : Make sure you use distinct meshes and at least two meshes'
...
if __name__ == """__main__""":
    if len(sys.argv) >1 :
        ...
        test_validation2DWaveSystemSourceCentered_brickwall(scaling)
    else :
        test_validation2DWaveSystemSourceCentered_brickwall(2)
