...
def test_validation2DWaveSystemSourcePStagFlatCrossTriangles(scaling):
    ...
    plt.savefig(mesh_name+"_2DWaveSystemSquareSourcePStag_"+"scaling"+str(scaling)+"_TimeSteps.png")
    ...
    det=a1*a3-a2*a2
    assert det!=0, 'test_validation2DWaveSystemSourceFVPStag() : Make sure you use distinct meshes and at least two meshes'
...
if __name__ == """__main__""":
    if len(sys.argv) >1 :
        ...
        test_validation2DWaveSystemSourcePStagFlatCrossTriangles(scaling)
    else :
        test_validation2DWaveSystemSourcePStagFlatCrossTriangles(2)
