...
if __name__ == """__main__""":
    if len(sys.argv) >2 :
        ...
        test_validation2DWaveSystemSourceUpwindTriangles(bctype,scaling)
    else :
        raise ValueError("test_validation2DWaveSystemSourceUpwindTriangles.py expects a mesh file name and a scaling parameter")
