...
def test_validation2DWaveSystemSourcePStagTriangles(scaling):
    ...
    plt.savefig(mesh_name+"_2DWaveSystemSourcePStags_"+"scaling"+str(scaling)+"_TimeSteps.png")
...
if __name__ == """__main__""":
    if len(sys.argv) >1 :
        ...
        test_validation2DWaveSystemSourcePStagTriangles(scaling)
    else :
        test_validation2DWaveSystemSourcePStagTriangles(2)
