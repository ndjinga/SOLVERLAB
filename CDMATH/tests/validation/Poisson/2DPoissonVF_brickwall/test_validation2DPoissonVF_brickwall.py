...
def test_validation2DVF_brickwall():
    start = time.time()
    ...
    plt.title('Plot over diagonal line for finite volumes \n for Laplace operator on 2D brickwall meshes')
    ...
    det=a1*a3-a2*a2
    assert det!=0, 'test_validation2DVF_brickwall() : Make sure you use distinct meshes and at least two meshes'
    a=( a3*b1-a2*b2)/det
    b=(-a2*b1+a1*b2)/det
    ...
    import os
    os.system("jupyter-nbconvert --to notebook --execute Convergence_Poisson_FV5_SQUARE_brickwall.ipynb")
    os.system("jupyter-nbconvert --to html Convergence_Poisson_FV5_SQUARE_brickwall.ipynb")
    os.system("jupyter-nbconvert --to pdf Convergence_Poisson_FV5_SQUARE_brickwall.ipynb")
