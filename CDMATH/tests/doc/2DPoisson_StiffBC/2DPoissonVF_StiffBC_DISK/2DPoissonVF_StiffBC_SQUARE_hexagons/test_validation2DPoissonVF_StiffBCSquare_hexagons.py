...
def test_validation2DVF_StiffBC_hexagons():
    start = time.time()
    #### 2D FV hexagon mesh of a square
    ...
    mesh_path='../../../ressources/2DSquareWithHexagons/'
    ...
    print( "FV on 2D square with hexagonal mesh : l2 scheme order is ", -a )
