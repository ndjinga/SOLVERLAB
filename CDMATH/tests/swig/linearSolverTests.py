...
class TestsLinearSolverSwig(unittest.TestCase):
    ...
    def testClassLinearSolver(self):
        ...
        #A1.getEigenvalues(    4, SLEPc.EPS.Which.SMALLEST_MAGNITUDE)#, 1.e-6, SLEPc.EPS.Type.KRYLOVSCHUR, True, 0.05);#Plot eigenvalues in a X-Windows
        #A1.getSingularValues( 4, SLEPc.SVD.Which.SMALLEST          , 1.e-6, SLEPc.SVD.Type.CYCLIC          , True, 0.05);#Plot eigenvalues in a X-Windows
