...
if __name__ == '__main__':
    nx=3
    mesh_square_with_cross_triangles(0.,1.,nx,0.,1.,2*nx,"squareWithCrossTriangles_0")
    nx=6
    mesh_square_with_cross_triangles(0.,1.,nx,0.,1.,2*nx,"squareWithCrossTriangles_1")
    nx=15
    mesh_square_with_cross_triangles(0.,1.,nx,0.,1.,2*nx,"squareWithCrossTriangles_2")
    nx=25
    mesh_square_with_cross_triangles(0.,1.,nx,0.,1.,2*nx,"squareWithCrossTriangles_3")
    nx=50
    mesh_square_with_cross_triangles(0.,1.,nx,0.,1.,2*nx,"squareWithCrossTriangles_4")
