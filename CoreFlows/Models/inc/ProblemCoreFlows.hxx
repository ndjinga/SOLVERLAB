...
public :
	 ...
	 * \param [in] FieldSupportType : CELLS, NODES or FACES
	 * \param [out] void
	 *  */
	void setInitialField(string fileName, string fieldName, int timeStepNumber, FieldSupportType typeField = FieldSupportType::CELLS);
	 ...
	 * \param [out] void
	 *  */
	void setInitialFieldConstant(string fileName, const vector<double> Vconstant, FieldSupportType typeField = FieldSupportType::CELLS);
	 ...
	 * \param [out] void
	 *  */
	void setInitialFieldConstant(const Mesh& M, const Vector Vconstant, FieldSupportType typeField = FieldSupportType::CELLS);
	 ...
	 * \param [out] void
	 *  */
	void setInitialFieldConstant(const Mesh& M, const vector<double> Vconstant, FieldSupportType typeField = FieldSupportType::CELLS);
	...
	void setInitialFieldConstant( int nDim, const vector<double> Vconstant, double xmin, double xmax,int nx, string leftSide, string rightSide,
			...
			double zmin=0, double zmax=0, int nz=0, string bottomSide="", string topSide="", FieldSupportType typeField = FieldSupportType::CELLS);
	 ...
	 * \param [out] void
	 *  */
	void setInitialFieldStepFunction(const Mesh M, const Vector Vleft, const Vector Vright, double disc_pos, int direction=0, FieldSupportType typeField = FieldSupportType::CELLS);
	 ...
	 * \param [out] void
	 *  */
	void setInitialFieldSphericalStepFunction(const Mesh M, const Vector Vin, const Vector Vout, double Radius, Vector Center, FieldSupportType typeField = FieldSupportType::CELLS);
