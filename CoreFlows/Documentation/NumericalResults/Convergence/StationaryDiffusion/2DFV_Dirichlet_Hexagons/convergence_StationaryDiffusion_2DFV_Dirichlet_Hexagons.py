...
def convergence_StationaryDiffusion_2DFV_Dirichlet_Hexagons():
    start = time.time() 
    ### 2D FV  hexagon meshes
    method = 'FV'
    BC = 'Dirichlet'
    ...
    det=a1*a3-a2*a2
    assert det!=0, 'convergence_StationaryDiffusion_2DFV_Dirichlet_Hexagons() : Make sure you use distinct meshes and at least two meshes'
    a=( a3*b1-a2*b2)/det
    b=(-a2*b1+a1*b2)/det
...
if __name__ == """__main__""":
    convergence_StationaryDiffusion_2DFV_Dirichlet_Hexagons()
