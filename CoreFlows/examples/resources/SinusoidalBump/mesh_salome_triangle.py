# $Id: mesh_salome_triangle.py,v 1.1 2010/07/27 09:44:33 kumbaro Exp $
# $Name: FLIVAP-1-1-1 $
#
...
hyp_qb.NumberOfSegments(nb_cells_nx / 4)
hyp_qb.Propagation()
...
mesh.ExportMED(dir_test + "Meshing/Mesh_40x10/bump_40x10_triangle.med")
