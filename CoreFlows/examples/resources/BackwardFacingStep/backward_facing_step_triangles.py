# Description: channel with backward facing step geometry, triangular mesh
#
# ---------------------------------------------------------------------------- #
#									       #
...
nb_cells_nx = 66#Number of segment on the top horizontal wall
nb_cells_ny = 6 #Number of segments at outlet
...
NETGEN_2D = mesh.Triangle(algo=smeshBuilder.NETGEN_2D)
...
# Export MED
mesh.ExportMED( "./backward_facing_step_triangles.med")
