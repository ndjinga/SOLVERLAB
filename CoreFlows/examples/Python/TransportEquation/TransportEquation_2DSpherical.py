...
def TransportEquation_2DSpherical(  fileName):
    ...
    """ Description : Test solving the transport of the enthalpy h in a fluid (water or steam). 
        Equation : Linear transport equation  dh/dt + \div h \vec v  = \lambda_{sf} (T_{solid} - T_{fluid}) 
                Phase (water or steam) and constant pressure of the fluid MUST be defined
    ...
    boundary1_type=solverlab.NeumannTransport# or solverlab.DirichletTransport
    ...
    boundary2_type=solverlab.DirichletTransport# or solverlab.NeumannTransport
    ...
    boundary3_type=solverlab.NeumannTransport# or solverlab.DirichletTransport
    ...
    boundary4_type=solverlab.DirichletTransport# or solverlab.NeumannTransport
