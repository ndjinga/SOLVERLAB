...
# Description : Utilisation de la méthode des éléments finis avec champs T et f discrétisés aux noeuds d'un maillage de triangles équilatéraux
...
def StationaryDiffusionEquation_2DFE_EquilateralTriangles():
	spaceDim = 2;
	...
	# name of result file
	fileName = "StationnaryDiffusion_2DFE_StructuredTriangles";
...
if __name__ == """__main__""":
	StationaryDiffusionEquation_2DFE_EquilateralTriangles()
