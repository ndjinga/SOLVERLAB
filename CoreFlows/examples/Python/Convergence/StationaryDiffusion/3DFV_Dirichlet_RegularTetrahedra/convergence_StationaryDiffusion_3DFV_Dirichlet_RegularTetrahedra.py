...
def convergence_StationaryDiffusion_3DFV_Dirichlet_RegularTetrahedra():
    start = time.time() 
    ...
    plt.savefig(mesh_name+"_3DFV_StatDiffusion_Dirichlet_PlotOverDiagonalLine.png")
    ...
    det=a1*a3-a2*a2
    assert det!=0, 'convergence_StationaryDiffusion_3DFV_Dirichlet_regularTetrahedra() : Make sure you use distinct meshes and at least two meshes'
    a=( a3*b1-a2*b2)/det
    b=(-a2*b1+a1*b2)/det
    ...
    plt.savefig(mesh_name+"_3DFV_StatDiffusion_Dirichlet_ConvergenceCurve.png")
    ...
    plt.savefig(mesh_name+"_3DFV_StatDiffusion_Dirichlet_ComputationalTime.png")
    ...
    convergence_synthesis["Space_dimn"]=3
...
if __name__ == """__main__""":
    convergence_StationaryDiffusion_3DFV_Dirichlet_RegularTetrahedra()
