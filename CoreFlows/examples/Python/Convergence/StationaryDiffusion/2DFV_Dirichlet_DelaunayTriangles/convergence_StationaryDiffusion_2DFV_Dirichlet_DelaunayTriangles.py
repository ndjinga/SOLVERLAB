...
def convergence_StationaryDiffusion_2DFV_Dirichlet_DelaunayTriangles():
    start = time.time() 
    ...
    det=a1*a3-a2*a2
    assert det!=0, 'convergence_StationaryDiffusion_2DFV_Dirichlet_DelaunayTriangles() : Make sure you use distinct meshes and at least two meshes'
    a=( a3*b1-a2*b2)/det
    b=(-a2*b1+a1*b2)/det
