...
if __name__ == "__main__":
  ...
  if packagespydir is None:
    raise ValueError("PACKAGESPY_ROOT_DIR environ variable not set, fix it.")
  sys.path.insert(0, os.path.join(packagespydir, "pythonAppliMatix"))
  s = os.path.join(packagespydir, "pythonAppliMatix")
  s = os.path.join(s, "solverlabGUI")
  sys.path.insert(0, s)
