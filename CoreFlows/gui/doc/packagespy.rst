...
Packagespy est une bibliothèque python développée au CEA_ permettant la création d'interfaces graphiques. Elle est basé sur le design du *Model-View-Controller* (voir ModelViewController_).
