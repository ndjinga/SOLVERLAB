...
One Bash script is generated. The scrpit generated will save the latest path use for PACKAGESPY_.
Without it you can't relaunch easily your case.
One python file is copied from PACKAGESPY_. It's needed to launch the simulation again because it need the Python class of your Solverlab Tree.
This mean you can modify it locally and launch your simulation with almost similar parameters.

If environment variable of Solverlab and PACKGESPY_ are not set the script will not work. You need to source SOLVERLAB_install/env_solverlab.sh then ./LaunchSolverlab.sh.
